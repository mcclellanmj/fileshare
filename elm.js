...
var _user$project$AddressableStates$generateFolderAddress = function (path) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'#folder/',
		_evancz$elm_http$Http$uriEncode(path));
};
var _user$project$AddressableStates$Folder = function (a) {
	return {ctor: 'Folder', _0: a};
};
var _user$project$AddressableStates$routeParser = _evancz$url_parser$UrlParser$oneOf(
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			_evancz$url_parser$UrlParser$format,
			_user$project$AddressableStates$Folder('.'),
			_evancz$url_parser$UrlParser$s('')),
			A2(
			_evancz$url_parser$UrlParser$format,
			function (_p0) {
				return _user$project$AddressableStates$Folder(
					_evancz$elm_http$Http$uriDecode(_p0));
			},
			A2(
				_evancz$url_parser$UrlParser_ops['</>'],
				_evancz$url_parser$UrlParser$s('folder'),
...
var _user$project$AddressableStates$decode = function (location) {
	return A3(
...
var _user$project$Service$createShareJson = F2(
	function (path, email) {
		...
		return A2(_elm_lang$core$Json_Encode$encode, 0, shareDetails);
	});
var _user$project$Service$ShareResult = F2(
	function (a, b) {
		return {uuid: a, url: b};
	});
var _user$project$Service$parseShare = A3(
	_elm_lang$core$Json_Decode$object2,
	_user$project$Service$ShareResult,
...
var _user$project$Service$shareFile = F2(
	function (path, email) {
		var url = A2(
		...
		return A3(
			...
			_user$project$Service$parseShare,
			url,
			_evancz$elm_http$Http$string(
				A2(_user$project$Service$createShareJson, path, email)));
	});
var _user$project$Service$File = F4(
	function (a, b, c, d) {
		return {shortName: a, fullPath: b, isFolder: c, size: d};
	});
var _user$project$Service$parseFiles = function () {
	var file = A5(
		_elm_lang$core$Json_Decode$object4,
		_user$project$Service$File,
		A2(_elm_lang$core$Json_Decode_ops[':='], 'short_name', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'full_path', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'is_folder', _elm_lang$core$Json_Decode$bool),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'size', _elm_lang$core$Json_Decode$int));
	return _elm_lang$core$Json_Decode$list(file);
}();
var _user$project$Service$fetchFiles = function (path) {
	var url = A2(
		_evancz$elm_http$Http$url,
		'/view',
		_elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: 'folder_path', _1: path}
			]));
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$html$Html_Events$onClick(closeMsg),
							_elm_lang$html$Html_Attributes$style(
							_elm_lang$core$Native_List.fromArray(
								[
...
var _user$project$SharePrompt$render = F3(
	function (closeMsg, shareFn, file) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					_user$project$SharePrompt$shareHeader,
					closeMsg,
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(folderName)
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
...
var _user$project$Main$toErrorText = function (err) {
	var _p0 = err;
	switch (_p0.ctor) {
		case 'Timeout':
			return 'Timeout';
...
var _user$project$Main$renderCoords = function (_p1) {
	var _p2 = _p1;
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'(',
...
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {active: a, path: b, prompt: c, files: d, windowSize: e};
	});
...
var _user$project$Main$FailedShare = function (a) {
	return {ctor: 'FailedShare', _0: a};
};
var _user$project$Main$Sharing = F2(
	function (a, b) {
		return {ctor: 'Sharing', _0: a, _1: b};
	});
var _user$project$Main$Shared = function (a) {
	return {ctor: 'Shared', _0: a};
};
var _user$project$Main$Share = function (a) {
	return {ctor: 'Share', _0: a};
};
var _user$project$Main$None = {ctor: 'None'};
var _user$project$Main$Folder = {ctor: 'Folder'};
var _user$project$Main$BadRoute = function (a) {
	return {ctor: 'BadRoute', _0: a};
};
var _user$project$Main$Loading = {ctor: 'Loading'};
var _user$project$Main$initialModel = {windowSize: _elm_lang$core$Maybe$Nothing, path: '', files: _user$project$Main$NotLoaded, active: _user$project$Main$Loading, prompt: _user$project$Main$None};
var _user$project$Main$ClosePrompt = {ctor: 'ClosePrompt'};
var _user$project$Main$ShareFinished = function (a) {
	return {ctor: 'ShareFinished', _0: a};
};
var _user$project$Main$ShareFailed = function (a) {
	return {ctor: 'ShareFailed', _0: a};
};
var _user$project$Main$shareCmd = F2(
	function (file, email) {
		return A3(
			_elm_lang$core$Task$perform,
			_user$project$Main$ShareFailed,
			_user$project$Main$ShareFinished,
			A2(_user$project$Service$shareFile, file.fullPath, email));
	});
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p3 = msg;
		switch (_p3.ctor) {
			case 'DirectoryFetchFailed':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							files: _user$project$Main$Error(_p3._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'DirectoryFetched':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							files: _user$project$Main$Loaded(_p3._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'WindowResize':
			...
			case 'ClosePrompt':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{prompt: _user$project$Main$None}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ShareMsg':
				var _p5 = _p3._0;
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							prompt: A2(_user$project$Main$Sharing, _p5, _p4)
						}),
					_1: A2(_user$project$Main$shareCmd, _p5, _p4)
				};
			case 'ShowSharePrompt':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							prompt: _user$project$Main$Share(_p3._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ShareFailed':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							prompt: _user$project$Main$FailedShare(_p3._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							prompt: _user$project$Main$Shared(_p3._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$Main$ShareMsg = F2(
	function (a, b) {
		return {ctor: 'ShareMsg', _0: a, _1: b};
	});
var _user$project$Main$ShowSharePrompt = function (a) {
	return {ctor: 'ShowSharePrompt', _0: a};
};
	...
	switch (_p7.ctor) {
		...
		case 'Loaded':
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[]),
				A2(_elm_lang$core$List$map, _user$project$Main$renderFile, _p7._0));
		default:
			return A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							'Failed due to: ',
							_user$project$Main$toErrorText(_p7._0)))
					]));
	}
};
var _user$project$Main$view = function (model) {
	var _p8 = model.active;
	switch (_p8.ctor) {
		case 'Folder':
			var _p9 = model.prompt;
			switch (_p9.ctor) {
				case 'None':
					return A2(
						_elm_lang$html$Html$div,
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_user$project$Main$renderFileHeader(model.path),
								_user$project$Main$renderFiles(model.files)
							]));
				case 'Share':
					return A3(_user$project$SharePrompt$render, _user$project$Main$ClosePrompt, _user$project$Main$ShareMsg, _p9._0);
				case 'Shared':
					return A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Shared it')
							]));
				case 'Sharing':
					return A2(
						_elm_lang$html$Html$div,
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Sharing it')
							]));
				default:
					return A2(
						_elm_lang$html$Html$div,
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Failed it')
							]));
			}
		case 'BadRoute':
			return A2(
...
var _user$project$Main$WindowSizeFailed = {ctor: 'WindowSizeFailed'};
var _user$project$Main$WindowResize = function (a) {
	return {ctor: 'WindowResize', _0: a};
};
var _user$project$Main$windowChange = function (dim) {
	return _user$project$Main$WindowResize(
		{ctor: '_Tuple2', _0: dim.width, _1: dim.height});
};
var _user$project$Main$getCurrentWindowSize = A3(
	_elm_lang$core$Task$perform,
	function (_p10) {
		return _user$project$Main$WindowSizeFailed;
	},
	_user$project$Main$windowChange,
	_elm_lang$window$Window$size);
var _user$project$Main$DirectoryFetchFailed = function (a) {
	return {ctor: 'DirectoryFetchFailed', _0: a};
};
var _user$project$Main$DirectoryFetched = function (a) {
	return {ctor: 'DirectoryFetched', _0: a};
};
var _user$project$Main$fetchCmd = function (path) {
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Main$DirectoryFetchFailed,
		_user$project$Main$DirectoryFetched,
		_user$project$Service$fetchFiles(path));
};
		...
		if (_p11.ctor === 'Err') {
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						active: _user$project$Main$BadRoute(_p11._0)
					}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		} else {
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{active: _user$project$Main$Folder, path: _p12, files: _user$project$Main$NotLoaded}),
				_1: _user$project$Main$fetchCmd(_p12)
			};
		}
	});
...
var _user$project$Main$main = {
	main: A2(
		...
		_elm_lang$navigation$Navigation$makeParser(_user$project$AddressableStates$decode),
		{
			init: _user$project$Main$init,
			subscriptions: function (_p13) {
				return _elm_lang$window$Window$resizes(_user$project$Main$windowChange);
			},
